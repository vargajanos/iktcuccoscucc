...
def nevjegy():
    ...
    uz2= Message(abl2, text='Készítette: Varga János\nDusnok\n2006.03.14', width=300)
...
henger=Menu(menu3)
henger.add_command(label="Felszín", command=hengerf, underline=0)
henger.add_command(label="Térfogat", command=hengert , underline=0)
